...
class Hotelimage_3 extends CI_Controller {
    ...
    public function test_parsing()
    {
        ...
        $qry = $this->db->query("select distinct city_code, item_code FROM hotel_gta_item WHERE is_sync = 0 order by id asc LIMIT $limit");
