<?php
$dirname_file = "/var/www/html/ctctravel.org/fit/webservices/abacus/";
define('PHP_SWS_PATH', $dirname_file);
require_once(PHP_SWS_PATH.'php_http_client_include.php');
class Abacus extends CI_Model {
	...
	var $from="ihsan.tay@ctc.com.sg";
	var $conversation_id="";
	var $username="8888";
	var $password="CTC78866";
    var $ipcc="8HYD";
	var $token="";
	var $error="";
