						...
						<span style="font-family:Courier; font-size: 13px;">
							...
							$connection = mysqli_connect(DB_LOCALHOST, DB_USERNAME, DB_PASSWORD, DB_NAME);
						 	$check_res  = mysqli_query(
								$connection,
								"
									SELECT DISTINCT adult_or_child as paxage, paxname, flag_room  FROM hotel_paxName WHERE bookingID = '".$bookingOrder."' AND RoomTypeID='".$hotelDetail->hotel_RoomTypeID."'
								"
							);
							if( mysqli_num_rows($check_res) > 0 ) {
								$na = 1;
