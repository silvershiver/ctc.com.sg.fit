...
<head>
	...
	<title>CTC Travel - Edit Cruise Price</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li><a href="<?php echo base_url(); ?>backend/product/cruise_price">Edit Cruise Price</a></li>
				</ul>
			</div>
			...
			<div class="content-wrapper">
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Summary of cruise price list</h5>																				<div style="float:right; margin-right:10px; margin-top:-25px">
							<button type="button" class="btn btn-primary btn-labeled" data-toggle="modal" data-target="#addPrice">
								<b><i class="icon-add"></i></b> Add new cruise price
							</button>
<!-- Add new cruise price -->
<div id="addPrice" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open_multipart('#', array('class' => 'form-horizontal')); ?>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title">Add new cruise price</h5>
				</div>
				<div class="modal-body">
					<fieldset class="content-group">
						<div class="form-group">
							<label class="control-label col-lg-4">Stateroom name</label>
							<div class="col-lg-8">
								<input type="text" name="cruise_stateroom_name" required class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Price</label>
							<div class="col-lg-8">
								<input type="text" name="cruise_stateroom_price" required class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Date</label>
							<div class="col-lg-8">
								<input type="text" name="cruise_stateroom_date" required class="form-control" />
							</div>
						</div>
					</fieldset>
				</div>
						...
						<tbody>
							<tr>
								...
								<td class="text-center" style="width:250px">
									<a class="btn btn-primary btn-labeled" data-toggle="modal" data-target="#ePrice">
										<b><i class="icon-pencil3"></i></b> Update
									</a>
<!--- Edit cruise price modal -->
<div id="ePrice" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open_multipart('#', array('class' => 'form-horizontal')); ?>			
				<div class="modal-header">
...
<!--- End of edit cruise brand modal -->
									<a href="#" onclick="return confirm('Are you sure you want to delete this brand? Please unlink all related cruise details with this price.')" class="btn btn-primary btn-labeled">
