...
<head>
	...
	<title>CTC Travel - Edit Cruise Date</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li><a href="<?php echo base_url(); ?>backend/product/cruise_date">Edit Cruise Date</a></li>
				</ul>
			</div>
			...
			<div class="content-wrapper">
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Summary of cruise date list</h5>																				<div style="float:right; margin-right:10px; margin-top:-25px">
							<button type="button" class="btn btn-primary btn-labeled" data-toggle="modal" data-target="#addDate">
								<b><i class="icon-add"></i></b> Add new cruise date
							</button>
<!-- Add new cruise date -->
<div id="addDate" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open_multipart('#', array('class' => 'form-horizontal')); ?>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title">Add new cruise date</h5>
				</div>
				<div class="modal-body">
					<fieldset class="content-group">
						<div class="form-group">
							<label class="control-label col-lg-4">Date of departure</label>
							<div class="col-lg-8">
								<input type="text" name="cruise_date_date" required class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Remark</label>
							<div class="col-lg-8">
...
<!--- End of edit cruise brand modal -->
									<a href="#" onclick="return confirm('Are you sure you want to delete this date? Please unlink all related cruise details with this date.')" class="btn btn-primary btn-labeled">
