...
<head>
	...
	<title>CTC Travel - Cruise Brand Management</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li><a href="<?php echo base_url(); ?>backend/product/cruise_brand">Cruise Brand Management</a></li>
				</ul>
			</div>
			...
			<div class="content-wrapper">
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Summary of cruise brand list</h5>																				<div style="float:right; margin-right:10px; margin-top:-25px">
							<button type="button" class="btn btn-primary btn-labeled" data-toggle="modal" data-target="#addBrand">
								<b><i class="icon-add"></i></b> Add new cruise brand
							</button>
<!-- Add new cruise brand -->
		...
		<div class="modal-content">
			<?php echo form_open_multipart('#', array('class' => 'form-horizontal')); ?>
				<div class="modal-header">
					...
					<h5 class="modal-title">Add new cruise brand</h5>
				</div>
				<div class="modal-body">
					<fieldset class="content-group">
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" name="cruise_brand_name" required class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">
							...
							<div class="col-lg-8">
								<textarea name="cruise_brand_desc" class="form-control" style="resize:none; height:150px"></textarea>
							</div>
						</div>
					</fieldset>
				</div>
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary">Add new cruise brand</button>
				</div>
			<?php echo form_close(); ?>							
		</div>
	</div>
</div>
<!-- End of add new cruise brand -->
						</div>
						...
						<tbody>
							<tr>
								...
								<td class="text-center" style="width:250px">
									<a class="btn btn-primary btn-labeled" data-toggle="modal" data-target="#eBrand">
										<b><i class="icon-pencil3"></i></b> Update
									</a>
<!--- Edit cruise brand modal -->
<div id="eBrand" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="http://54.251.177.123/iostream/backend/device/do_devicetype_edit" method="post" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">			
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title">Edit cruise brand</h5>
				</div>
				<div class="modal-body">
					<fieldset class="content-group">
						<div class="form-group">
