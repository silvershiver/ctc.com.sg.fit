...
<head>
	...
	<title>CTC Travel - Cruise Product Management</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li><a href="<?php echo base_url(); ?>backend/product/cruise_index">Product Cruise Management</a></li>
				</ul>
			</div>
	...
	<div class="page-container">
		<div class="page-content">
			<div class="content-wrapper">
				<?php echo $this->session->flashdata('suspendCruise'); ?>
				<?php echo $this->session->flashdata('activeCruise'); ?>
				<?php echo $this->session->flashdata('deleteCruiseTitleSuccess'); ?>
						...
						foreach($cruise_titles as $cru_title){
							...
							<tr>
                                ...
                                <td style="text-align:center">
                                    <?php
	                                if( $cru_title->IS_SUSPEND == 0 ) {
		                            	echo anchor('backend/product/delete_cruise/'.$cru_title->ID, "<b><i class='icon-cross'></i></b> Make it inactive", array('onclick'=>"return confirm('Are you sure you want to suspend this cruise?')")); 
		                            }
		                            else {
			                         	echo anchor('backend/product/make_cruise_active/'.$cru_title->ID, "<b><i class='icon-check'></i></b> Make it active", array('onclick'=>"return confirm('Are you sure you want to active this cruise?')"));   
		                            }
									?>
									&nbsp;&nbsp;&nbsp;
									<?php 
									echo anchor('#', "<b><i class='icon-pencil3'></i></b> Image(s)", array("data-toggle" => "modal", "data-target" => "#manageImage".$cru_title->ID)); 
									?>
<!-- Add image modal -->
...
<!-- End of Add image modal -->
									&nbsp;&nbsp;&nbsp;
									<?php 
									echo anchor('backend/product/remove_dx_cruise/'.$cru_title->ID, "<b><i class='icon-trash'></i></b> Delete", array('onclick'=>"return confirm('Are you sure you want to delete this cruise?')")); 
									?>
                                </td>
							</tr>						
						<?php
