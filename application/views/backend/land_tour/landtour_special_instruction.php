...
<head>
	...
	<title>CTC Travel - Land Tour - Manage Special Instruction</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li>
						<a href="<?php echo base_url(); ?>backend/product/landtour_special_instruction">Manage Special Instruction</a>
					</li>
				</ul>
			</div>
						...
						<table class="table datatable-basic">
							...
							<tbody>
								...
								<tr>
										...
										<div id="editInstruction<?php echo $list->id; ?>" class="modal fade">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<?php echo form_open_multipart('backend/landtour_process/update_special_instruction', array('class' => 'form-horizontal')); ?>
									...
									<td>
										<a href="<?php echo base_url(); ?>backend/landtour_process/delete_special_instruction/<?php echo $list->id; ?>" onclick="return confirm('Are you sure you want to delete this record?')"><b><i class='icon-trash'></i></b> Delete</a>
									</td>
								</tr>
								<?php
									}
                ...
                <div class="col-md-4">
                	...
                	<div class="panel">       
                		<div class="add_new_sidebar">              
							...
							<?php echo form_open_multipart('backend/landtour_process/insert_special_instruction/', array('class' => 'form-horizontal')); ?>
							<div class="modal-body">	
