<?php
    $mealCodeArray = array(
            'P' => 'Alcoholic beverages for purchase', 'B' => 'Breakfast', 'O' => 'Cold meal', 'C' => 'Complimentary alcoholic beverages', 'K' => 'Continental Breakfast', 'D' => 'Dinner', 'F' => 'Food for purchase',
            'G' => 'Food and Beverage / for purchase', 'H' => 'Hot Meal', 'L' => 'Lunch', 'MS' => 'Multi Meals', 'M' => 'Meal', 'N' => 'No meal service', 'R' => 'Refreshment', 'V' => 'Refreshment / for purchase', 'S' => 'Snack',
            'AVML' => 'Asian Vegetarian Meal', 'BBML' => 'Baby Meal', 'CAKE' => 'Birthday Cake (on SAS)',
            'BLML' => 'Bland Meal', 'CHML' => 'Children Meal', 'CLML' => 'Celebration Cake Meal',
            'DBML' => 'Diabetic Meal', 'FPML' => 'Fruit Platter Meal',
            'GFML' => 'Gluten Intolerant Meal', 'LCML' => 'Low Calorie Meal',
            'HFML' => 'High Fibre Meal', 'HNML' => 'Hindu Meal', 'JNML' => 'Jain Meal', 'KSML' => 'Kosher Meal', 'KSMLS' => 'Kosher Meal (Snack)', 'LFML' => 'Low Fat Meal', 'NLML' => 'Low Lactose Meal', 'PRML' => 'Low Purin Meal', 'LPML' => 'Low Protein Meal', 'LSML' => 'Low Salt Meal', 'MOML' => 'Moslem Meal', 'ORML' => 'Oriental Meal', 'PFML' => 'Peanut Free Meal', 'RFML' => 'Refugee Meal (on United Airlines)', 'SFML' => 'Seafood Meal',
            'VJML' => 'Vegetarian Jain Meal', 'VLML' => 'Vegetarian Lacto-ovo Meal',
            'VOML' => 'Vegetarian Oriental Meal', 'RVML' => 'Vegetarian Raw Meal',
            'VVML' => 'Vegetarian Vegan Meal', 'VGML' => 'Vegetarian Vegan Meal', 'SPML/No Beef' => 'No Beef Meal', 'SPML/Liquid Diet' => 'Liquid Diet Meal',
            'LRML' => 'Low Residue Meal', 'LR' => 'Low Residue Meal', 'SF' => 'Seafood Meal'
        );


     $airEquipTypeArr = array(
     	'319' => 'Airbus',     	'320' => 'Airbus', '321' => 'Airbus',
     	'332' => 'AIRBUS INDUSTRIE A330-200','333' => 'AIRBUS INDUSTRIE 330-300',
     	'350' => 'Airbus A350', '359' => 'AIRBUS A359','388' => 'AIRBUS INDUSTRIE A380-800',
     	'738' => 'BOEING 737-800', '739' => 'BOEING 737-900', '73J' => 'BOEING 737', '773' => 'BOEING 777-300', '777' => 'BOEING 777',
     	'772' => 'BOEING 777-200', '77W' => 'BOEING 777-300ER', '789' => 'BOEING 787-9'
     );
	...
	$bookingOrder = $this->uri->segment(4);
...
<div style="width: 880px; margin:0 auto">
    ...
    <table width="100%" cellpadding="1" cellspacing="0" style="border-top: 1px solid black;">
        ...
        $hardcode = false;
        if($bookingOrder == '5a4506febb46b' || $bookingOrder == '5a450760415b3' || 	$bookingOrder == '5a45067fe839d'
    		)	{
        	$gtabookingdata = TRUE;
        	$hardcode = true ;
    	}
		...
		<?php
	        ...
	        <tr>
	            ...
	            <td align="left" valign="top" colspan="2">
		            <span style="font-family:Courier; font-size: 13px; text-transform: uppercase">SGD <?php echo number_format(ceil($itemTotalPrice) + ceil($taxTotalPrice), 2);?></span>
	            </td>
	        </tr>
	    <?php
