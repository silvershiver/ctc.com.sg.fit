			...
			<div class="content clearfix">
				...
				<section class="three-fourth">
					...
					<section class="gallery" id="crossfade">
						<img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="850" height="531" />
						<img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="850" height="531" />
						<img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="850" height="531" />
						<img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="850" height="531" />
					</section>
					...
					<nav class="inner-nav">
						<ul>
                            ...
                            <li class="availability"><a href="#flight_availability" title="Flight Availability">Flight Availability</a></li>
					...
					<section id="availability" class="tab-content">
						<article>
							...
							<ul class="room-types">
								<!--room-->
								<li>
									<figure class="left"><img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="270" height="152" /><a href="<?php echo base_url();?>images/slider/img.jpg" class="image-overlay" rel="prettyPhoto[gallery1]"></a></figure>
									<div class="meta">
									...
									<div class="room-information">
										<div class="row">
											...
											<span class="second"><img src="<?php echo base_url();?>images/ico/person.png" alt="" /><img src="<?php echo base_url();?>images/ico/person.png" alt="" /></span>
										</div>
										<div class="row">
								...
								<li>
									...
									<div class="room-information">
										<div class="row">
											<span class="first">Max:</span>
											<span class="second"><img src="<?php echo base_url();?>images/ico/person.png" alt="" /></span>
										</div>
										<div class="row">
											<span class="first">Price:</span>
											<span class="second">$ 55</span>
								...
								<li>
									...
									<div class="room-information">
										<div class="row">
											<span class="first">Max:</span>
											<span class="second"><img src="<?php echo base_url();?>images/ico/person.png" alt="" /><img src="<?php echo base_url();?>images/ico/person.png" alt="" /><img src="<?php echo base_url();?>images/ico/person.png" alt="" /></span>
										</div>
										<div class="row">
											<span class="first">Price:</span>
											<span class="second">$ 55</span>
                    ...
                    <!--flight availability-->
					<section id="flight_availability" class="tab-content">
						<article>
					...
					<section id="reviews" class="tab-content">
						...
						<article>
							...
							<ul class="reviews">
								<!--review-->
								<li>
									<figure class="left"><img src="<?php echo base_url();?>images/uploads/avatar.jpg" alt="avatar" /></figure>
					...
					<section id="things-to-do" class="tab-content">
						<article>
							<h1>London</h1>
							<figure class="left_pic"><img src="<?php echo base_url();?>images/uploads/img.jpg" alt="Things to do - London general" /></figure>
							...
							<figure class="left_pic"><img src="<?php echo base_url();?>images/uploads/img.jpg" alt="Things to do - London Sports and nature" /></figure>
							...
							<h1>Nightlife</h1>
							<figure class="left_pic"><img src="<?php echo base_url();?>images/uploads/img.jpg" alt="Things to do - London Nightlife" /></figure>
				...
				<aside class="right-sidebar">
					...
					<article class="default clearfix">
						...
						<div class="deal-of-the-day">
							<a href="hotel.html">
								<figure><img src="<?php echo base_url();?>images/slider/img.jpg" alt="" width="230" height="130" /></figure>
								<h3>Plaza Resort Hotel &amp; SPA
									<span class="stars">
										<img src="<?php echo base_url();?>images/ico/star.png" alt="" />
										<img src="<?php echo base_url();?>images/ico/star.png" alt="" />
