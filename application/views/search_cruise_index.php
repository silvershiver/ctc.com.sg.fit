...
<head>
	...
	<title>CTC Travel | Search Cruise Result</title>
	...
	<div class="column twins last">
		...
		<div class="f-item">
			...
			<select name="noofAdult" style="height:19px">
				<option value="1" <?php if( $noofAdult == "1" ) { echo 'SELECTED'; } ?>>1 pax</option>
				<option value="2" <?php if( $noofAdult == "2" ) { echo 'SELECTED'; } ?>>2 pax(s)</option>
				<option value="3" <?php if( $noofAdult == "3" ) { echo 'SELECTED'; } ?>>3 pax(s)</option>
				<option value="4" <?php if( $noofAdult == "4" ) { echo 'SELECTED'; } ?>>4 pax(s)</option>
			</select>
		</div>
		<div class="f-item">
			<label>No. of children</label>
			<select name="noofChildren" style="height:19px">
				<option value="0" <?php if( $noofChildren == "0" ) { echo 'SELECTED'; } ?>>0 pax</option>
				<option value="1" <?php if( $noofChildren == "1" ) { echo 'SELECTED'; } ?>>1 pax</option>
				<option value="2" <?php if( $noofChildren == "2" ) { echo 'SELECTED'; } ?>>2 pax(s)</option>
				<option value="3" <?php if( $noofChildren == "3" ) { echo 'SELECTED'; } ?>>3 pax(s)</option>
				<option value="4" <?php if( $noofChildren == "4" ) { echo 'SELECTED'; } ?>>4 pax(s)</option>
			</select>
		</div>
	</div>
	<!--//column-->
					...
					<article class="refine-search-results">
						...
						<dl>				
							...
							<dd id="FilterCKBrand">
								...
								?>
								<div class="checkbox">
									<input type="checkbox" id="fB" name="filterBrand[]" value="<?php echo $cruiseTypeFilter->ID; ?>" required />
									&nbsp;
									<span style="font-size:12px"><?php echo $cruiseTypeFilter->NAME; ?></span>
								</div>
								<?php
									}
								}
						...
						<dl>
							...
							<dd>
								<div class="checkbox">
									<input type="checkbox" id="ch6" name="filterLength[]" value="1,2" required />
									&nbsp;
									<span style="font-size:12px">1-2 Nights</span>
								</div>
								<div class="checkbox">
									<input type="checkbox" id="ch6" name="filterLength[]" value="3,4,5,6" required />
									&nbsp;
									<span style="font-size:12px">3-6 Nights</span>
								</div>
								<div class="checkbox">
									<input type="checkbox" id="ch6" name="filterLength[]" value="7,8,9" required />
									&nbsp;
									<span style="font-size:12px">7-9 Nights</span>
								</div>
								<div class="checkbox">
									<input type="checkbox" id="ch6" name="filterLength[]" value="10,11,12,13,14" required />
									&nbsp;
									<span style="font-size:12px">10-14 Nights</span>
								</div>
								<div class="checkbox">
									<input type="checkbox" id="ch6" name="filterLength[]" value="15,16,17,18,19,20,21,22,23" required />
									&nbsp;
									<span style="font-size:12px">Over 14 Nights</span>
								</div>
							</dd>
							<!--End of Search by-->
						</dl>
				...
				<section class="three-fourth">
					<div class="sort-by">
						...
						<ul class="sort">
							...
							<li style="width:150px">
								<?php
								if( $cruiseLength == "ALL" ) 		  { $printDate = 'All lengths'; }
								else if( $cruiseLength == "1_2" ) 	  { $printDate = '1-2 nights'; }
								else if( $cruiseLength == "3_6" ) 	  { $printDate = '3-6 nights'; }
								else if( $cruiseLength == "7_9" ) 	  { $printDate = '7-9 nights'; }
								else if( $cruiseLength == "10_14" )   { $printDate = '10-14 nights'; }
								else if( $cruiseLength == "OVER_14" ) { $printDate = 'Over 14 nights'; }
								?>
								Length: <?php echo $printDate; ?>
							</li>
						</ul>
					</div>
