							...
							<tr class="days">
								<th width="25%" style="text-align:left; background-color:#efefef" rowspan="4">
									<div style="font-size:12px; margin:10px">
										<img src="<?php echo $this->All->getLandtourImage($success_landtour->landtour_product_id); ?>" alt="" width="100" height="100" />
									</div>
								</th>
							</tr>
							<tr>
								<td colspan="3" style="text-align:left; padding-bottom:0px; background-color:#efefef">
								...
								?>
									...
									?>
										<tr>
											...
											<td class='time' style="background-color:rgb(255, 145, 38); color:white; padding:10px; font-size:12px; text-align:center">
									...
									<tr>
										...
										<td class='time' style="background-color:rgb(255, 145, 38); color:white; padding:10px; font-size:12px; text-align:center">
											<?php
											$totalPaxPrice = ($adultPrice*$paxGetQty[0])+($paxGetQty[1]*$child_wb_price)+($paxGetQty[2]*$child_wob_price)+($paxGetQty[3]*$infant_price);
											$totalGrandPrice += ($adultPrice*$paxGetQty[0])+($paxGetQty[1]*$child_wb_price)+($paxGetQty[2]*$child_wob_price)+($paxGetQty[3]*$infant_price);
											?>
											$<?php echo number_format($totalPaxPrice, 2); ?>
										</td>
									</tr>
									...
									<div style="font-size:15px">
										<div>
											<b>
												...
												if( $success_landtour->sellingType == "ticket" ) {
												?>
													$<?php echo number_format($totalGrandPriceTicket, 2); ?>
												<?php
												}
												else {
												?>
