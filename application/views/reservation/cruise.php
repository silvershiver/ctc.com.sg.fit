								...
								<tr class="days">
									<th width="25%" style="text-align:left; background-color:#efefef" rowspan="4">
										<div style="font-size:12px; margin:10px">
											<img src="<?php echo $this->All->getCruiseImage($success_cruise->cruiseTitleID); ?>" alt="" width="100" height="100" />
										</div>
									</th>
								</tr>
								<tr>
									<td colspan="4" style="text-align:left; padding-bottom:0px; background-color:#efefef">
