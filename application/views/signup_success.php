...
<head>
	...
	<title>CTC Travel | Signup Activation</title>
...
<body>
	...
	$checks = $this->All->select_template_w_2_conditions(
		"email_address", $parameter, "is_block", 1, "user_access"
	);
	if( $checks == TRUE ) {
		$data_fields = array(
			"is_block" 			=> 0,
		...
		$update = $this->All->update_template($data_fields, "email_address", $parameter, "user_access");
	?>
		<!--MAIN-->
			...
			<div class="wrap clearfix">
				...
				<section class="boxes clearfix">
					<article class="full-fourth">
						<h2>Notification</h2>
						<p>Your account is now activated. You may proceed to login.</p>
					</article>
				</section>
			</div>
		</div>
