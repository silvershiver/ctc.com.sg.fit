...
<title>CTCFITApp - Email confirmation</title>
<style type="text/css">
    body {
        width: 100%; 
				                			...
				                			<tr>
				                				<td align="center">
				                					<a href="" style="display: block; border-style: none !important; border: 0 !important;">
					                					...
					                					<span style="color:white">{Logo CTCFITApp Here}</span>
					                				</a>
				                				</td>
				                			</tr>
				                		</table>
...
Dear <span style="color:white"><?php echo $email_address; ?></span>,						
                											</td>
                										</tr>
...
<p>This is a receipt to your signup activation request.</p>
<p>
    <div>Please <a href="<?php echo $reset_link; ?>" style="color:white" target="_blank">CLICK HERE</a> to active your account.</div>
</p>
                											</td>
                										</tr>
                									</table>
                							...
                							<tr>
                								<td>
                									...
                									<table border="0" width="360" align="right" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="section-item">
                										...
                										<tr>
                											<td>
                												<a href="<?php echo base_url(); ?>support" style="display: block; width: 80px; border-style: none !important; border: 0 !important;"><img editable="true" mc:edit="readMoreBtn" width="80" height="26" border="0" style="display: block;" src="<?php echo base_url(); ?>assets/email/img/readmore-btn.png" alt="Read more" /></a>
                											</td>
                										</tr>
                									</table>
                	...
                	<tr>
                		<td align="center" mc:edit="copy1" style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-header">	
							...
							<span style="color: #2780cb"><?php echo $email_address; ?></span> 
							<br /><br />
							<a style="text-decoration: none; color: #2780cb;" href="<?php echo base_url(); ?>unsubcribe/index/<?php echo $email_address; ?>">unsubscribe from our newsletters</a>
                		</td>
                	</tr>	
                	...
                	<tr>
                		<td align="center" mc:edit="copy2" style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader">
	                			...
	                			For Local: 6532 0532 | For Overseas: +65 6530 0338 &nbsp;&nbsp;&nbsp; 
	                			<span style="color: #2780cb">Email :</span> enquiry@ctc.com.sg	
                		</td>
                	</tr>
